// buyers.js — signupBuyer + minimal buyer handlers (safe stubs; replace with real implementations)
...
export async function signupBuyer(request, env) {
  try {
    ...
    // Create buyer profile row (idempotent behavior is left to DB constraints)
